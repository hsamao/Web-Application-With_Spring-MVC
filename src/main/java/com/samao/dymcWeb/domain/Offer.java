...
import com.samao.dymcWeb.validation.ValidEmail;
...
public class Offer {
    ...
    @Size(min = 5, max = 100, message = "Name must be between 5 and 1000 characters: ")
    private String name;
    ...
    @Size(min = 25, max = 250, message = "Text must be between 20 and 255 characters")
    private String text;
